...
export async function POST(req) {
  ...
  if (body.action === 'search') {
    ...
    try {
      const url = `https://query1.finance.yahoo.com/v1/finance/search?q=${encodeURIComponent(keyword)}&quotesCount=8&newsCount=0&listsCount=0`
      const res = await fetch(url, {
